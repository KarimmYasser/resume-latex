...
\newcommand{\mySummary}{%
\textbf{Computer Engineer} with a strong foundation in \textbf{Quantum Computing} and \textbf{Post-Quantum Cryptography}. Experienced in developing high-performance software systems (C++, Rust) and autonomous robotics. Proven track record in full-stack development and machine learning integration. Passionate about transitioning into \textbf{Quantum Computing Engineering}, leveraging deep theoretical research in cryptographic security and mathematical optimization to build the next generation of secure, quantum-resistant systems.
}
