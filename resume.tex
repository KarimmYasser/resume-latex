...
\begin{samepage}
\begin{twocolentry}{
\mbox{Jan 2025 - Feb 2025 | \hrefWithoutArrow{https://github.com/KarimmYasser/hangouts_crincale}{GitHub}}%
}
...
\item \textbf{Frameworks \& Libraries:} Bloc, Provider, GetX, Dagger/Hilt, Navigation Component, Room, Retrofit, Firebase, RESTful APIs
\item \textbf{Backend \& Database:} Supabase, Firebase, SQLite, Room, SQL, MySQL, Database Design, API Integration
\item \textbf{Development Tools:} Git, GitHub, Docker, VS Code, Android Studio, Desktop App Development, Web Scraping, Agile
\item \textbf{Software Engineering:} Clean Architecture, SOLID Principles, Dependency Injection, State Management, OOP, Design Patterns
\end{highlights}
\end{samepage}
