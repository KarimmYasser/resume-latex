...
\begin{onecolentry}
\begin{highlights}
Collaborated in a team of five to develop a beginner-friendly Android app for logging expenses, focusing on core concepts like Activity lifecycle and Intents.
\end{highlights}
\end{onecolentry}
\end{samepage}
